...
def obtener_animes(variacion):
    ...
    """
    anime_1 = Anime("BnHA", 25, 6, 2016, "Sunrise", {"Acción", "Aventura", "Comedia"})
    anime_2 = Anime("Gintama", 202, 10, 2016, "Sunrise", {"Parodia"})
    anime_3 = Anime("Chihiro", 1, 9, 2011, "Ghibli", {"Fantasía", "Aventura"})
    anime_4 = Anime("Amapolas", 1, 3, 2011, "Ghibli", {"Romance"})
    anime_5 = Anime(
        "Sakura", 71, 10, 1998, "Madhouse", {"Comedia", "Acción", "Romance"}
    )
...
class VerificarConsultasResumenAnimes(unittest.TestCase):
    ...
    def test_resultado_2_anime(self):
        ...
        self.assertEqual(resumen["capitulos total"], 26)
        self.assertSetEqual(
    ...
    def test_resultado_varios_anime(self):
        ...
        self.assertEqual(resumen["capitulos total"], 300)
        self.assertSetEqual(
            resumen["generos"],
