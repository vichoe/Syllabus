...
class VerificarClaseFaitHibrido(unittest.TestCase):
    ...
    def test_init_correcto(self):
        ...
        """
        auto = FaitHibrido(rendimiento=9, marca="c", energia=105.9, bencina_favorita=95)
        self.assertEqual(auto.rendimiento, 9)
        self.assertEqual(auto.marca, "c")
        self.assertEqual(auto.energia, 105.9)
        self.assertEqual(auto.vida_util_bateria, 5)

        auto2 = FaitHibrido(
            rendimiento=7, marca="c2", energia=231.3, bencina_favorita=95
        )
        self.assertEqual(auto2.rendimiento, 7)
        self.assertEqual(auto2.marca, "c2")
        self.assertEqual(auto2.energia, 231.3)
    ...
    def test_llama_recorrer_clases_padres_sobre_10_km(self):
        ...
        with patch("clases.AutoBencina.recorrer") as mock:
            ...
            with patch("clases.AutoElectrico.recorrer") as mock2:
                ...
                mock2.assert_called_once_with(auto, 5.0)
    ...
    def test_llama_recorrer_clases_padres_bajo_10_km(self):
        ...
        with patch("clases.AutoBencina.recorrer") as mock:
            ...
            with patch("clases.AutoElectrico.recorrer") as mock2:
                ...
                mock2.assert_called_once_with(auto2, 1.2)
    ...
    def test_no_llama_init_auto_bencina(self):
        ...
        with patch("clases.AutoBencina.__init__") as mock:
            mock.return_value = None
            FaitHibrido(rendimiento=4, marca="c2", energia=101, bencina_favorita=95)
            mock.assert_called_once()
    ...
    def test_llama_init_auto_electrico(self):
        ...
        with patch("clases.AutoElectrico.__init__") as mock:
            mock.return_value = None
            FaitHibrido(rendimiento=1, marca="c2", energia=121, bencina_favorita=95)
            mock.assert_called_once()
    ...
    def test_recorrer_FaitHibrido_sobre_10_km(self):
        ...
        self.assertIn(
            ...
            [
                ...
                "Anduve 10.0Km y eso consume 10.0L de bencina Anduve 0.5Km y eso consume 0.5W de energia electrica",
            ]
        )
    ...
    def test_recorrer_FaitHibrido_bajo_10_km(self):
        ...
        res = auto.recorrer(5.4)
        self.assertEqual(res, "Anduve 5.4Km y eso consume 2.7W de energia electrica")
