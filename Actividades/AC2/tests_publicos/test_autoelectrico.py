...
class VerificarClaseAutoElectrico(unittest.TestCase):
    ...
    def test_llama_init_vehiculo(self):
        ...
        with patch("clases.Vehiculo.__init__") as mock:
            ...
            AutoElectrico(vida_util_bateria=2, rendimiento=10, marca="c", energia=100.4)
