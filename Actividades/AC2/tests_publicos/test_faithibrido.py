...
class VerificarClaseFaitHibrido(unittest.TestCase):
    ...
    def test_recorrer_FaitHibrido_sobre_10_km(self):
        ...
        self.assertEqual(
            res,
            "Anduve por 10Km y gaste 10.0L de bencina Anduve por 0.5Km y gaste 0.5W de energia electrica",
        )
    ...
    def test_recorrer_FaitHibrido_bajo_10_km(self):
        ...
        self.assertEqual(res, "Anduve por 5.2Km y gaste 2.6W de energia electrica")
    ...
    def test_recorrer_FaitHibrido_justo_10_km(self):
        ...
        self.assertEqual(res, "Anduve por 10.0Km y gaste 5.0W de energia electrica")
